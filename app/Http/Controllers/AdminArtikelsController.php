<?php namespace App\Http\Controllers;
	...
	class AdminArtikelsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kategori","name"=>"kategori_id","join"=>"kategoris,nama_kategori"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kategori Id','name'=>'kategori_id','type'=>'select2','validation'=>'required|min:1','width'=>'col-sm-10','datatable'=>'kategoris,nama_kategori'];
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'required|image|max:5000','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Deskripsi Singkat','name'=>'deskripsi_singkat','type'=>'text','validation'=>'required|min:1','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Keyword','name'=>'keyword','type'=>'text','validation'=>'required|min:1','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'wysiwyg','validation'=>'required|string|min:5','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Keyword","name"=>"keyword","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
            ...
            $this->addaction[] = ['label'=>'Share','target'=>'_blank','url'=>'https://wa.me/?text=https://readerstacks.com','icon'=>'fa fa-whatsapp','color'=>'success'];
	    ...
	    */
	    public function hook_before_add(&$postdata) {
            ...
            $cekSlug = DB::table('artikels')->where('slug', $slug)->first();
            if($cekSlug){
